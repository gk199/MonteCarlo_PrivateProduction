...
In 112X, used `--conditions auto:phase1_2021_realistic`. Based on the L1 twiki, now use `--conditions=123X_mcRun3_2021_realistic_v5`. Also set the HB TDC to be unpacked in the digi step, until this is resolved in a CMSSW PR / backport: `--customise_commands 'process.hcalRawDatauHTR.packHBTDC = cms.bool(False)'`.
```
condor_argu=HTo2LongLivedTo4b_MH-125_MFF-50_CTau-3000mm_TuneCP5_13TeV_pythia8_cff
EVENTS=2000

cmsDriver.py Configuration/GenProduction/python/$condor_argu.py --python_filename $condor_argu-1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --fileout file:/eos/cms/store/group/dpg_hcal/comm_hcal/gillian/LLP_Run3/124X/$condor_argu_123X.root --conditions 123X_mcRun3_2021_realistic_v5 --beamspot Run3RoundOptics25ns13TeVLowSigmaZ --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(100) --step GEN,SIM --geometry DB:Extended --era Run3 --no_exec --mc -n $EVENTS

cmsDriver.py step2 --python_filename $condor_argu-digi_1_cfg.py --conditions 123X_mcRun3_2021_realistic_v5 --pileup_input das:/RelValMinBias_14TeV/CMSSW_11_2_0_pre8-112X_mcRun3_2021_realistic_v10-v1/GEN-SIM -n $EVENTS --era Run3 --eventcontent FEVTDEBUGHLT -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2021 --datatier GEN-SIM-DIGI-RAW --pileup Run3_Flat55To75_PoissonOOTPU --customise_commands 'process.hcalRawDatauHTR.packHBTDC = cms.bool(False)' --geometry DB:Extended --filein file:/eos/cms/store/group/dpg_hcal/comm_hcal/gillian/LLP_Run3/124X/$condor_argu_123X.root --fileout file:/eos/cms/store/group/dpg_hcal/comm_hcal/gillian/LLP_Run3/124X/$condor_argu-digi_123X.root --no_exec --mc  

cmsDriver.py l1Ntuple -s RAW2DIGI --python_filename=mc_ntuples_$condor_argu.py -n 100 --no_output --era=Run3 --mc --conditions=123X_mcRun3_2021_realistic_v5 --customise=L1Trigger/Configuration/customiseReEmul.L1TReEmulMCFromRAW --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleRAWEMUGEN_MC --customise=L1Trigger/Configuration/customiseSettings.L1TSettingsToCaloParams_2022_v0_1 --filein=file:/eos/cms/store/group/dpg_hcal/comm_hcal/gillian/LLP_Run3/124X/$condor_argu-digi_123X.root --no_exec
```
